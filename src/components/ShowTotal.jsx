    ...
    return (
        <>
            ...
            <div>
                ...
                <p className="mb-1 mt-4 text-lg">User1 gastó: <span className="text-amber-500 font-bold">${expensesUser1}</span></p>
                <p className="text-lg">User2 gastó: <span className="text-amber-500 font-bold">${expensesUser2}</span></p>
                { division > 0 ? 
